...
$toe=$_POST['toe'];
 $query=mysqli_query($con,"insert into tblservice(sWorker, sPhone, sNo, sCategory, sTime) value('$visname','$mobnumber', '$apart', '$category','$toe')");
...
<head>
    ...
    <!-- Title Page-->
    <title>GateKeepr Visitors Forms</title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Add</strong> New Service Workers
                                    </div>
    ...
    echo $msg;
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Service Worker Name</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="visname" name="visname" placeholder="Worker Name" class="form-control" required="true">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">All Apartment Nos</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                            ...
                                            <!-- <div class="row form-group">
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="category" name="category" placeholder="Category" class="form-control" required="true">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Time Of Entry</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="toe" name="toe" placeholder="Time of Entry" class="form-control" required="true">
