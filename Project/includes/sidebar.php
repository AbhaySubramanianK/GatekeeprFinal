<aside class="menu-sidebar d-none d-md-block">
    <div class="logo">
        <h1>The GateKeepr</h1>
    </div>
    <div class="menu-sidebar__content js-scrollbar1">
        <nav class="navbar-sidebar">
            <ul class="list-unstyled navbar__list">
                ...
                <li>
                    <a href="add_Service_Worker.php" style="color: blue">
                        <i class="fas fa-copy"></i>Add Service Workers</a>
                </li>    
                <li>
                    <a href="view_Service_Worker.php" style="color: blue">
                        <i class="fas fa-copy"></i>View Service Workers</a>
                </li> 
            </ul>
        </nav>
    </div>
