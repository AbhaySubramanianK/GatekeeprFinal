    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                    <div style="background-image: url('images/icon/brigade1.jpg');">

                <div class="section__content section__content--p30">
                    <h1 style="color: white">Brigade Meadows Appartment</h1>
                                ...
                                <div class="overview-item overview-item--c2">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2>
                                                    <?php echo $count_yesterday_visitors?>
                                                </h2>
                                ...
                                <div class="overview-item overview-item--c3">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2>
                                                    <?php echo $count_lastsevendays_visitors?>
                                                </h2>
...
$count_total_visitors=mysqli_num_rows($query3);
 ?>
            ...
            <br>
<?php
$query3=mysqli_query($con,"select ID from tblservice");
$count_total_visitors1=mysqli_num_rows($query3);
?>
            <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c4">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2>
                                                    <?php echo $count_total_visitors1?>
                                                </h2>
